...
namespace Scheduling
{
    ...
    {
        int jobnum, procnum, macnum, chromosomelength = 0;
        bool refresh;
        Schedule[] population;
        ...
        void Procedure()
        {
            Task t1 = new Task(() =>
            {
                ...
                while (produced < 10000000)
                {
                    ...
                    Boolean ch1 = checkBestValueChanged(child1);
                    Boolean ch2 = checkBestValueChanged(child2);
                    if (ch2 || ch1)
                    {
                        //                        Console.WriteLine("Mother Job: " + mother.JobsToString()+" Mother Mac: " + mother.MacToString());
                        //                        Console.WriteLine("Job:        " + best.JobsToString()+" Mac:        " + best.MacToString());
                        //                        Console.WriteLine("Father Job: " + father.JobsToString()+" Father Mac: " + father.MacToString());
                    }
                    produced++;
                    nothingFound++;
                    ...
                    if (stopped)
                    {
                        Console.WriteLine("Job final:  " + best.JobsToString());
                        Console.WriteLine("Mac final:  " + best.MacToString());
                        break;
                    }
                }
            });
        ...
        {
            int[] jobSchedule = new int[chromosomelength];
            int[] macSchedule = new int[chromosomelength];

            int[] used = new int[jobnum];
            bool[] assigned = new bool[chromosomelength];
        ...
        bool checkBestValueChanged(Schedule tour)
        {
        ...
        //Sort nums to incremental fit value 
        ...
        void ExchangeValuesMutation(Schedule sch)
        {
            ...
            x1 = rnd.Next(0, chromosomelength);
            x2 = rnd.Next(0, chromosomelength);
